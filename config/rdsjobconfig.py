...
class RDSJobConfig(JobConfig):
    def __init__(self, source_connection_string, dest_connection_string, source_table_name, dest_table_name,
        ...
        JobConfig.__init__(self, dest_connection_string, source_table_name, dest_table_name, timestamp_col, status_table_name, redshift_role)
