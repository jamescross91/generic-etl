...
class RDSJobConfig(ETLJobConfig):
    def __init__(self, source_connection_string, dest_connection_string, source_table_name, dest_table_name,
                 timestamp_col, s3_bucket_name, status_table_name, redshift_role, run_before, run_after):
        ETLJobConfig.__init__(self, dest_connection_string, source_table_name, dest_table_name, timestamp_col,
